...
public:
    ...
    uint8_t program_bank_count() const { return m_header.program_bank_count; }
    uint8_t character_bank_count() const { return m_header.character_bank_count; }
    ...
    static constexpr uint16_t HeaderSize = 16;
